    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            if user_doc.exists:
                ...
                print('User profile not found.', 'danger')
        except Exception as e:
            print(f'Login failed: {e}', 'danger')
...
def register():
    ...
    if form.validate_on_submit():
        ...
        try:
            # Use Pyrebase to create the user with email/password authentication
            user = current_app.firebase_auth.create_user_with_email_and_password(email, password)
            user_id = user['localId']  # This is the user ID generated by Firebase Authentication

            # Use Firebase Admin SDK to store the user profile in Firestore
            ...
            print(f"Form not submitted successfully.{e}")
